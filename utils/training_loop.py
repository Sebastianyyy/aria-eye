...
def training_loop(config):
    ...
    if not os.path.exists(log_dir):
        ...
        print(f"Log directory already exists: {log_dir}. Skipping logging setup, but logs will continue.")
    ...
    writer = SummaryWriter(log_dir=os.path.join(log_dir, "tensorboard"))  # Create a subdirectory for tensorboard logs
